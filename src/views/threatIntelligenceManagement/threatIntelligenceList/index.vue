    ...
    <el-card class="box-card">
      <div>
        <el-row :gutter="20">
          ...
          >
            <el-col :span="6">
              <el-form-item label="APT组织:" prop="ev_ksec_aptOrganization">
                <el-input
                  v-model.trim="queryParams.ev_ksec_aptOrganization"
            ...
            <el-col :span="6">
              <el-form-item label="攻击者IP:" prop="ev_com_socket_src_ip">
                <el-input
                  v-model.trim="queryParams.ev_com_socket_src_ip"
...
import { ThreatIntelligenceList,stateChanges,notificationExport,putInStorage } from "@/api/system/list";
export default {
  components: {},
  props: [],
  data() {
