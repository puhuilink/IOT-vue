      ...
      <div>
        <el-collapse v-model="activeNames">
          <el-collapse-item name="1">
            <span slot="title"
                  class="collapse-title">搜索条件</span>
            <el-form ref="queryForm"
              ...
              <el-col :span="6">
                <el-form-item label="目的IP地址："
                              prop="userName">
                  <el-input v-model="queryParams.destinationIp"
              ...
              <el-col :span="6">
                <el-form-item label="处置状态："
                              prop="ipaddr">
                  <el-select v-model="formData.disposalStatus"
                             placeholder="请选择处置状态"
                             clearable
                             :style="{ width: '100%' }">
          ...
          <el-form ref="elForm"
            ...
            <el-col :span="12">
              <el-form-item label="源IP："
                            prop="sourceIp">
                <el-input v-model="dialogDetail.sourceIp"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="源设备："
                            prop="field102">
                <el-input v-model="dialogDetail.sourceDevice"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="源端口："
                            prop="sourcePort">
                <el-input v-model="dialogDetail.sourcePort"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="源MAC："
                            prop="field104">
                <el-input v-model="dialogDetail.sourceMac"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="目的IP："
                            prop="aimIp">
                <el-input v-model="dialogDetail.destinationIp"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="目的MAC："
                            prop="field106">
                <el-input v-model="dialogDetail.destinationMac"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="目的设备："
                            prop="field107">
                <el-input v-model="dialogDetail.destinationEquipment"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="目的端口："
                            prop="aimPort">
                <el-input v-model="dialogDetail.destinationPort"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="传输层协议："
                            prop="transportProtocol">
                <el-input v-model="dialogDetail.transportLayerProtocol"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="应用层协议："
                            prop="applyProtocol">
                <el-input v-model="dialogDetail.applicationLayerProtocol"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="事件级别："
                            prop="level">
                <el-input v-model="dialogDetail.eventLevel"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label=" 事件类型："
                            prop="type">
                <el-input v-model="dialogDetail.eventCategory"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="产生时间："
                            prop="happen">
                <el-input v-model="dialogDetail.generationTime"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="接收时间："
                            prop="field114">
                <el-input v-model="dialogDetail.receivingTime"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="智能监测终端IP："
                            prop="field115">
                <el-input v-model="dialogDetail.intelligentMonitoringTerminalIp"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="区域："
                            prop="region">
                <el-input v-model="dialogDetail.region"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="处置状态："
                            prop="state">
                <el-input v-model="dialogDetail.disposalStatus"
                          readonly
                          :style="{ width: '100%' }" />
              </el-form-item>
            </el-col>
