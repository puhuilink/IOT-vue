            ...
            <el-form ref="queryForm"
              ...
              <el-col :span="6">
                <el-form-item label="事件类型："
                              prop="userName">
                  <el-input v-model="queryParams.eventCategory"
                            placeholder="请输入事件类型"
                            clearable
                            :style="{ width: '100%' }"
                            @keyup.enter.native="handleQuery" />
          ...
          <el-form ref="elForm"
            ...
            <el-col :span="12">
              <el-form-item label="源IP："
                            prop="sourceIp">
                <tooltip :content="detailData.sourceIp"
                         :length="20" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="源设备：">
                <tooltip :content="detailData.sourceDevice"
                         :length="20" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="源端口："
                            prop="sourcePort">
                <tooltip :content="detailData.sourcePort"
                         :length="20" />
            ...
            <el-col :span="12">
              <el-form-item label="源MAC：">
                <tooltip :content="detailData.sourceMac"
                         :length="20" />
            ...
            <el-col :span="12">
              <el-form-item label="目的IP："
                            prop="aimIp">
                <tooltip :content="detailData.destinationIp"
                         :length="20" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="目的MAC："
                            prop="field106">
                <tooltip :content="detailData.destinationMac"
                         :length="20" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="目的设备："
                            prop="field107">
                <tooltip :content="detailData.destinationEquipment"
                         :length="20" />
            ...
            <el-col :span="12">
              <el-form-item label="目的端口："
                            prop="aimPort">
                <tooltip :content="detailData.destinationPort"
                         :length="20" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="传输层协议："
                ...
                <tooltip :content="detailData.transportLayerProtocol"
                         :length="20" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="应用层协议："
                            prop="applyProtocol">
                <tooltip :content="detailData.applicationLayerProtocol"
                         :length="20" />
            ...
            <el-col :span="12">
              <el-form-item label="事件级别："
                            prop="level">
                <tooltip :content="detailData.eventLevel"
                         :length="20" />
            ...
            <el-col :span="12">
              <el-form-item label=" 事件类型："
                            prop="type">
                <tooltip :content="detailData.eventCategory"
                         :length="20" />
            ...
            <el-col :span="12">
              <el-form-item label="产生时间："
                            prop="happen">
                <tooltip :content="detailData.generationTime"
                         :length="20" />
            ...
            <el-col :span="12">
              <el-form-item label="区域："
                            prop="region">
                <tooltip :content="detailData.region"
                         :length="20" />
            ...
            <el-col :span="12">
              <el-form-item label="处置状态："
                            prop="state">
                <tooltip :content="detailData.disposalStatus"
                         :length="20" />
              </el-form-item>
            </el-col>
          </el-form>
