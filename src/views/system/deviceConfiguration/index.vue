      ...
      <el-col :span="6">
        <el-form-item label="配置模板"
          ...
          <el-select v-model="formData.level"
                     ...
                     clearable
                     :style="{ width: '100%' }">
            <el-option v-for="(item, index) in assetTypes"
                       :key="index"
                       :label="item.label"
                       :value="item.value"
    ...
    <el-row :gutter="10"
      ...
      <el-col :span="1.5">
        ...
        icon="el-icon-plus"
                   size="mini"
                   @click="handleAdd"
                   v-hasPermi="['system:user:add']">新建</el-button>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      <el-col :span="6">
        <el-card class="theHostBox">
          <div class="">
            ...
            <div class="host">级联配置</div>
            <div class="operations">
              <div class="el-icon-view" />
              <div class="el-icon-edit-outline"
                   @click="edit" />
              <div class="el-icon-delete"
                   @click="handleForceLogout" />
            </div>
            <div class="wxy">wxy</div>
            <div class="numberOfDevices">最新更新时间</div>
            <!-- <div class="lastUpdated">最新更新时间</div> -->
            <div class="numberOfDevices">2022-01-07 08:00:00</div>
