      ...
      <div>
        <el-row :gutter="20">
          <el-form ref="elForm"
            ...
            <el-col :span="6">
              <el-form-item label="通报编号："
                            prop="id">
                <el-input v-model="queryParams.notificationManagementId"
                          placeholder="请输入通报编号"
                          clearable
                          :style="{width: '100%'}" />
              </el-form-item>
            ...
            <el-col :span="6">
              <el-form-item label="事件类型："
                            prop="eventType">
                <el-select v-model="queryParams.eventType"
                           placeholder="请选择事件类型"
                           filterable
                           clearable
                           :style="{width: '100%'}">
                  <el-option v-for="(item, index) in eventTypeOptions"
                             :key="index"
                             :label="item.label"
                             :value="item.value"
            ...
            <el-col :span="6">
              <el-form-item label="通报状态："
                            prop="level">
                <el-select v-model="queryParams.notificationStatus"
                           placeholder="请选择通报状态"
                           filterable
                           clearable
                           :style="{width: '100%'}">
                  <el-option v-for="(item, index) in notificationStatusOptions"
                             :key="index"
                             :label="item.label"
                             :value="item.label"
                             :disabled="item.disabled" />
    ...
    <el-table :data="groupList"
      ...
      <el-table-column label="操作"
        ...
        <template #default="scope">
          ...
          <el-button size="mini"
                     type="text">上报</el-button>
          <el-button size="mini"
                     type="text"
                     @click="end(scope.row)">完成</el-button>
        </template>
      </el-table-column>
    </el-table>
      ...
      <div class="contentBox">
        <el-form ref="form"
          ...
          <el-form-item label="事件名称:"
                        prop="groupOrder">
            <el-input v-model="form.groupOrder"
                      placeholder="" />
          </el-form-item>
          ...
          <el-form-item label="上报:"
            ...
            <el-select v-model="form.report"
                       ...
                       clearable
                       :style="{width: '100%'}">
              <el-option v-for="(item, index) in reportOptions"
                         :key="index"
                         :label="item.label"
                         :value="item.value"
                         :disabled="item.disabled" />
